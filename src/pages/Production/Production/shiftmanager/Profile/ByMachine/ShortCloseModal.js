...
export default function ShortCloseModal({openShortClose,setOpenShortClose,response1,selectProgramCompleted,selectedMachine,setSelectProgramCompleted,setMachineProgramesCompleted}) {
    const handleClose=()=>{
